...
//     the main element
//     a header with the h1 
//     and a div with class 'App-list'.
// The App component will accept 1 prop, store.
//     The store prop is an object with 2 keys:
//         lists and allCards.
//     lists is an array of objects.
//     allCards is an object where 
//         each key is a card's ID 
//         and the value is the card object 
//             with a title and content.
// You'll be given a dummy STORE object to pass to your App.
// The App should render a List component 
//     for each of the items in the store.lists array.
